...
@VoluntarilyRegister
public class UzukiSlashBladeRegister extends SlashBladeRegister {
    ...
    @VoluntarilyRegister
    public static class UzukiSlashBladeRecipeRegister extends SlashBladeRecipeSerializerRegister.SlashBladeRecipeRegister {
        ...
        protected SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack defaultConfigSlashBladeRecipeRecipePack() {
            ...
            return new SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack(
                    ...
                    MapUtil.of(
                            ...
                            "D", new IRecipeInItemPack.OfIngredient(Ingredient.fromItems(Items.CARROT)),
                            "V", new IRecipeInItemPack.OfSlashBlade(namelessSlashBlade)
                    ),
                    "V",
                    new IResultPack.OfSlashBladeRegister(uzukiSlashBladeRegister)
            );
        }
    }
}
