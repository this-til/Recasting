...
@VoluntarilyRegister
public class MutsukiSlashBladeRegister extends SlashBladeRegister {
    ...
    @VoluntarilyRegister
    public static class MutsukiSlashBladeRecipeRegister extends SlashBladeRecipeSerializerRegister.SlashBladeRecipeRegister {
        ...
        protected SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack defaultConfigSlashBladeRecipeRecipePack() {
            ...
            return new SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack(
                    ...
                    MapUtil.of(
                            ...
                            "D", new IRecipeInItemPack.OfIngredient(Ingredient.fromItems(Items.SPRUCE_SAPLING)),
                            "V", new IRecipeInItemPack.OfSlashBlade(namelessSlashBlade)
                    ),
                    "V",
                    new IResultPack.OfSlashBladeRegister(mutsukiSlashBladeRegister)
            );
        }
    }
}
