...
@VoluntarilyRegister
public class AioSlashBladeRegister extends SlashBladeRegister {

    @Override
    protected void defaultItemStackConfig(ItemStack itemStack) {
        super.defaultItemStackConfig(itemStack);
        slashBladePack.getSlashBladeState().setBaseAttackModifier(6);
        slashBladePack.getSlashBladeState().setEffectColor(new Color(-255));
    }

    @VoluntarilyRegister
    public static class AioSlashBladeRecipeRegister extends SlashBladeRecipeSerializerRegister.SlashBladeRecipeRegister {
        @VoluntarilyAssignment
        protected AioSlashBladeRegister aioSlashBladeRegister;
        @VoluntarilyAssignment
        ...
        protected SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack defaultConfigSlashBladeRecipeRecipePack() {
            ...
            return new SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack(
                    ...
                    MapUtil.of(
                            ...
                            "D", new IRecipeInItemPack.OfIngredient(Ingredient.fromItems(Items.SUNFLOWER)),
                            "V", new IRecipeInItemPack.OfSlashBlade(namelessSlashBlade)
                    ),
                    "V",
                    new IResultPack.OfSlashBladeRegister(aioSlashBladeRegister)
            );
        }
    }
}
