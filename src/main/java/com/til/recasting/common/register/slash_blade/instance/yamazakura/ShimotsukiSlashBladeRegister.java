...
@VoluntarilyRegister
public class ShimotsukiSlashBladeRegister extends SlashBladeRegister {

    @Override
    protected void defaultItemStackConfig(ItemStack itemStack) {
        super.defaultItemStackConfig(itemStack);
        slashBladePack.getSlashBladeState().setBaseAttackModifier(6);
        slashBladePack.getSlashBladeState().setEffectColor(new Color(11067104));
    }

    @VoluntarilyRegister
    public static class  ShimotsukiSlashBladeRecipeRegister extends SlashBladeRecipeSerializerRegister.SlashBladeRecipeRegister {
        ...
        protected SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack defaultConfigSlashBladeRecipeRecipePack() {
            ...
            return new SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack(
                    ...
                    MapUtil.of(
                            ...
                            "D", new IRecipeInItemPack.OfIngredient(Ingredient.fromItems(Items.AZURE_BLUET)),
                            "V", new IRecipeInItemPack.OfSlashBlade(namelessSlashBlade)
                    ),
                    "V",
                    new IResultPack.OfSlashBladeRegister(shimotsukiSlashBladeRegister)
            );
        }
    }
}
