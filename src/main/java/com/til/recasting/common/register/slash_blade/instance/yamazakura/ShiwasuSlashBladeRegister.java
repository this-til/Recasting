...
@VoluntarilyRegister
public class ShiwasuSlashBladeRegister extends SlashBladeRegister {
    ...
    @VoluntarilyRegister
    public static class  ShiwasuSlashBladeRecipeRegister extends SlashBladeRecipeSerializerRegister.SlashBladeRecipeRegister {
        ...
        protected SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack defaultConfigSlashBladeRecipeRecipePack() {
            ...
            return new SlashBladeRecipeSerializerRegister.SlashBladeRecipeRecipePack(
                    ...
                    MapUtil.of(
                            ...
                            "D", new IRecipeInItemPack.OfIngredient(Ingredient.fromItems(Items.WHITE_TULIP)),
                            "V", new IRecipeInItemPack.OfSlashBlade(namelessSlashBlade)
                    ),
                    "V",
                    new IResultPack.OfSlashBladeRegister(shiwasuSlashBladeRegister)
            );
        }
    }
}
