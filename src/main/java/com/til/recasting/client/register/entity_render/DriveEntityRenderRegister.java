...
import com.til.recasting.client.render.entity.DriveEntityRender;
...
@OnlyIn(Dist.CLIENT)
@VoluntarilyRegister
public class DriveEntityRenderRegister extends IndependenceEntityRenderRegister<DriveEntity, DriveEntityTypeRegister, DriveEntityRender<?>> {
